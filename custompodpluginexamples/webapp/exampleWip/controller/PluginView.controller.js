sap.ui.define([
    ...
    "rits/custom/pod/examples/custompodpluginexamples/exampleWip/util/NetworkGraphLoader"
    ...
    PluginViewController.extend("rits.custom.pod.examples.custompodpluginexamples.exampleWip.controller.PluginView", {
        onInit: function () {
        ...
        onSfcNodeSelection: function(oEvent) {
           console.log("on sfc node is clicked....");
        ...
        openOrderDetail: function (oNode, oButton) {
            ...
            var that = this;
            if (!this._oQuickOrderView) {
                var sFragment = "rits.custom.pod.examples.custompodpluginexamples.exampleWip.view.fragments.OrderFragment";
        ...
        openSfcDetail: function (oNode, oButton) {
            console.log("open sfc detail is clicked....");
            var oSfcData = this.getCustomDataValue(oNode, "data");
            console.log("open sfc deatails data: ",oSfcData);
            var oModel = new JSONModel({
                icon: oNode.getIcon(),
                title: oNode.getKey(),
                description: oNode.getDescription(),
                sfc: oSfcData.sfc?.sfc || "",
                quantity: oSfcData.quantity || 0,
                scrappedQuantity: oSfcData.scrappedQuantity || 0,
                doneQuantity: oSfcData.doneQuantity || 0,
                quantityRejected: oSfcData.quantityRejected || 0,
                quantityInQueue: oSfcData.quantityInQueue || 0,
                quantityInWork: oSfcData.quantityInWork || 0
            });

            var that = this;
            if (!this._oQuickSfcView) {
                var sFragment = "rits.custom.pod.examples.custompodpluginexamples.exampleWip.view.fragments.SfcFragment";
