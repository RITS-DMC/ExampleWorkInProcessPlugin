sap.ui.define([
    ...
    var oLogger = Logging.getLogger("rits.custom.pod.examples.custompodpluginexamples.exampleWip.util.NetworkGraphLoader");

    var NetworkGraphLoader = BaseObject.extend("rits.custom.pod.examples.custompodpluginexamples.exampleWip.util.NetworkGraphLoader", {
    ...
    NetworkGraphLoader.prototype._addSfcNode = function(oSfc, sParent) {
        console.log("adding sfc details.....");
        console.log("o SFC Data: ",oSfc);
        // find current step
    ...
    NetworkGraphLoader.prototype._addMaterialNode = function(oMaterial, sParent) {
        ...
        var oNode = {
            ...
            "description": oMaterial.material,
    ...
    NetworkGraphLoader.prototype._addOperationNode = function(oStep, sParent) {
        ...
        var oNode = {
            ...
            "description": oOperation.operation,
